...
import 'package:eventoury/web/Vendor/Auth Screens/Login Screen/backend/vendor_login_controller.dart';
import 'package:font_awesome_flutter/font_awesome_flutter.dart';
import 'package:eventoury/web/Vendor/Auth Screens/Signup Screen/frontend/SignUpScreenVendor.dart';

class LoginScreenVendor extends StatefulWidget {
  const LoginScreenVendor({super.key});
                    ...
                    Expanded(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text('Welcome Back Vendor', style: TextStyle(fontSize: 28, fontWeight: FontWeight.bold, color: theme.textTheme.titleLarge?.color)),
                            ...
                            const SizedBox(height: 12),
                            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [TextButton(onPressed: () {}, child: Text('Forgot Password?', style: TextStyle(color: EventouryColors.tangerine))), TextButton(onPressed: () { Get.to(() => const SignUpScreenVendor()); }, child: Text('Sign Up', style: TextStyle(color: EventouryColors.tangerine)))]),
